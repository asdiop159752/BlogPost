...
<CustomImage src="https://raw.githubusercontent.com/asdiop159752/BlogPost/master/images/HTTP-SSL_TLS.png" alt="Warning: HTTP-SSL_TLS" />
...
<CustomImage src="https://raw.githubusercontent.com/asdiop159752/BlogPost/master/images/use-SSL-TLS.png" alt="Warning: use-SSL-TLS" />
...
Xác nhận quyền sử dụng tên miền Xác nhận tổ chức tồn tại hợp pháp Xác nhận tổ chức tồn tại thực tế Xác nhận hoạt độngcủa tổ chức Xác nhận người phê duyệt, người ký tên.
...
<CustomImage src="https://raw.githubusercontent.com/asdiop159752/BlogPost/master/images/SSL_TLS-lien-quan-gi-HTTPS.png" alt="Warning:SSL_TLS-lien-quan-gi-HTTPS" />
